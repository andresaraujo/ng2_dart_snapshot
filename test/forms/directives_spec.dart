...
import "package:angular2/test_lib.dart"
    show
        ...
        AsyncTestCompleter,
        inject;
import "package:angular2/angular2.dart" show QueryList;
  ...
  describe("Form Directives", () {
    describe("NgFormModel", () {
      ...
      beforeEach(() {
        ...
        form.form = formModel;
        loginControlDir = new NgControlName(form, new QueryList<dynamic>());
    ...
    describe("NgFormControl", () {
      ...
      var control;
      beforeEach(() {
        controlDir = new NgFormControl(new QueryList<dynamic>());
    ...
    describe("NgModel", () {
      var ngModel;
      beforeEach(() {
        ngModel = new NgModel(new QueryList<dynamic>());
    ...
    describe("NgControlName", () {
      ...
      beforeEach(() {
        ...
        controlNameDir = new NgControlName(parent, new QueryList<dynamic>());
