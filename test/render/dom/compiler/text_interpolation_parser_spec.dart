...
main() {
  describe("TextInterpolationParser", () {
    ...
    List<ElementBinderBuilder> process(element) {
    ...
    assertTextBinding(elementBinder, bindingIndex, nodeIndex, expression) {
      expect(elementBinder.textBindings[bindingIndex].source)
          .toEqual(expression);
      expect(elementBinder.textBindingNodes[bindingIndex]).toEqual(DOM
          .childNodes(DOM.templateAwareRoot(elementBinder.element))[nodeIndex]);
    }
