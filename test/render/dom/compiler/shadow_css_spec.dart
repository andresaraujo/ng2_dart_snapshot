library angular2.test.render.dom.compiler.shadow_css_spec;
...
import "package:angular2/test_lib.dart"
    show
        ...
        el,
        normalizeCSS;
import "package:angular2/src/render/dom/compiler/shadow_css.dart"
    show ShadowCss;
  ...
  describe("ShadowCss", () {
    ...
    if (isPresent(DOM.defaultDoc().body.style) &&
      ...
      it("should handle keyframes rules", () {
        ...
        var passRe = new RegExp(
            r'@keyframes foo {\s*0% {\s*transform:translate\(-50%\) scaleX\(0\);\s*}\s*}');
    ...
    if (DOM.getUserAgent().indexOf("AppleWebKit") > -1) {
      it("should handle -webkit-keyframes rules", () {
        ...
        var passRe = new RegExp(
            r'@-webkit-keyframes foo {\s*0% {\s*(-webkit-)*transform:translate\(-50%\) scaleX\(0\);\s*}}');
        expect(RegExpWrapper.test(passRe, s(css, "a"))).toEqual(true);
      });
    }
