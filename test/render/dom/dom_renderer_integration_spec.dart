...
import "dom_testbed.dart" show DomTestbed, TestView, elRef;
  ...
  describe("DomRenderer integration", () {
    ...
    it("should not create LightDom instances if the host element is empty",
      ...
      tb
        ...
        var cmpView =
            tb.createComponentView(rootView.viewRef, 0, protoViewDtos[1]);
        expect(cmpView.rawView.proto.elementBinders[0].componentId)
            .toBe("someComponent");
    ...
    it("should update any element property/attributes/class/style independent of the compilation",
      ...
      tb
        ...
        tb.renderer.setElementProperty(
            elRef(cmpView.viewRef, 0), "value", "hello");
        expect(((el as dynamic)).value).toEqual("hello");
        tb.renderer.setElementClass(elRef(cmpView.viewRef, 0), "a", true);
        expect(((DOM.childNodes(tb.rootEl)[0] as dynamic)).value)
            .toEqual("hello");
        ...
        tb.renderer.setElementAttribute(
            elRef(cmpView.viewRef, 0), "someAttr", "someValue");
      ...
      it("should call actions on the element independent of the compilation",
        ...
        tb
          ...
          tb.renderer.invokeElementMethod(
              elRef(componentView.viewRef, 0), "setAttribute", ["a", "b"]);
          expect(DOM.getAttribute(DOM.childNodes(tb.rootEl)[0], "a"))
              .toEqual("b");
          async.done();
        });
      }));
