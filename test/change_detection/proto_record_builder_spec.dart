library angular2.test.change_detection.proto_record_builder_spec;
...
main() {
  describe("ProtoRecordBuilder", () {
    it("should set argumentToPureFunction flag", inject([Parser], (Parser p) {
    ...
    it("should not set argumentToPureFunction flag when not needed", inject(
        [Parser], (Parser p) {
      var builder = new ProtoRecordBuilder();
