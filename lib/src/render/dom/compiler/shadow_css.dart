library angular2.src.render.dom.compiler.shadow_css;
...
var _cssContentNextSelectorRe = new RegExp(
    r'polyfill-next-selector[^}]*content:[\s]*?[' +
        ...
        r'"](.*?)[' +
        "'" +
        r'"][;\s]*}([^{]*?){', multiLine: true, caseSensitive: false);
var _cssContentRuleRe = new RegExp(r'(polyfill-rule)[^}]*(content:[\s]*[' +
    "'" +
    r'"](.*?)[' +
    "'" +
    r'"])[;\s]*[^}]*}', multiLine: true, caseSensitive: false);
