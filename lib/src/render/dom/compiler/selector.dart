...
class CssSelector {
  ...
  String toString() {
    ...
    ListWrapper.forEach(this.notSelectors, (notSelector) {
...
class SelectorMatcher {
  ...
  Map<String, List<SelectorContext>> _elementMap = new Map();
  Map<String, SelectorMatcher> _elementPartialMap = new Map();
  Map<String, List<SelectorContext>> _classMap = new Map();
  Map<String, SelectorMatcher> _classPartialMap = new Map();
  Map<String, Map<String, List<SelectorContext>>> _attrValueMap = new Map();
  Map<String, Map<String, SelectorMatcher>> _attrValuePartialMap = new Map();
  ...
  */
  ...
  bool _matchTerminal(Map<String, List<SelectorContext>> map, name,
      ...
      dynamic /* (CssSelector, any) => void */ matchedCallback) {
...
class SelectorContext {
  ...
  bool finalize(CssSelector cssSelector, callback) {
    var result = true;
